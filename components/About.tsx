...
const About: FC = () => {
  return (
    <section className="relative w-screen h-max min-h-screen overflow-hidden text-white xl:snap-center text-center bg-primary flex flex-col items-start pl-3 pt-10 justify-start md:pl-16 xl:pl-24 md:pt-12">
      ...
      <motion.div
          ...
          className="xl:w-[35%] w-full h-max leading-6 font-outerLight lg:text-base text-sm text-left md:mt-24 mt-20 pr-6">
      ...
      <div
        className="bg-[#382773] absolute -right-[43rem] -top-1/3 h-[110vh] xl:flex hidden w-[200vh] rotate-45 items-center pb-2 flex-col justify-end">
          <div className={`h-[18%] w-max space-x-3 flex p-[0.375rem] hover:pause animate-scroll4`}>
          ...
          <div className={`h-[18%] w-max space-x-3 flex p-[0.375rem] hover:pause animate-scroll3`}>
          ...
          <div className={`h-[18%] w-max space-x-3 flex p-[0.375rem] hover:pause animate-scroll2`}>
          ...
          <div className={`h-[18%] w-max space-x-3 flex p-[0.375rem] hover:pause animate-scroll1`}>
      ...
      <div className="animate-scrollResp hover:pause h-32 mt-16 w-max xl:hidden flex items-center p-3 space-x-3 bg-[#382773]">
