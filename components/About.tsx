  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Hello! I&apos;m <span className="text-secondary">&lt;PrananshSingh/&gt;</span>, a developer who enjoys
          crafting software across the entire spectrum—from polished user interfaces to the nitty-gritty of system
          internals. I believe great engineering means understanding how the pieces fit together, whether I&apos;m
          designing a robust API, tuning a database query, or exploring what happens at the metal.
        </motion.p>
        <motion.p
          initial={{ y: 100, opacity: 0 }}
          whileInView={{ y: 0, opacity: 1 }}
        ...
        >
          ...
          optimizing performance where it counts. And I love digging into low-level concepts: memory models,
        ...
        >
          <br />
          Ultimately, I&apos;m driven by curiosity—whether it&apos;s a new framework, a systems programming language, or
          a clever architectural pattern. I&apos;m always looking to learn and apply those insights to build software
