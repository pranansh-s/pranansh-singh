...
const Contact: FC = () => {
  return (
    <section className="relative w-screen h-screen text-white lg:snap-center text-center bg-primary flex justify-center items-start pt-10 md:justify-start md:pl-24 md:pt-12">
