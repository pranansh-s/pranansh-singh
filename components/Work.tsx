...
const Work: FC = () => {
  ...
  return (
    <section className="relative w-screen h-max text-white text-center bg-primary flex flex-col justify-center items-start md:justify-start">
      <header className="relative top-[10%] md:pl-24 pl-3 md:pt-12 pt-10">
