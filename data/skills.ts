...
export const RowAll: Card[] = [
  { logo: '../logos/react.svg', color: '61DBFB' },
  { logo: '../logos/tailwindcss.png', color: 'FFFFFF' },
  { logo: '../logos/nextjs.png', color: '000000' },
  { logo: '../logos/postcss.png', color: 'FFFFFF' },
  ...
  { logo: '../logos/mongodb.png', color: 'FFFFFF' },
  { logo: '../logos/socket-io.svg', color: 'FFFFFF' },
  { logo: '../logos/visual-studio.svg', color: '000000' },
